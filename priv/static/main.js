...
var author$project$NodeDict$NodeDict = F2(
	function (a, b) {
		return {$: 'NodeDict', a: a, b: b};
	});
...
var author$project$NodeDict$singleton = F2(
	function (key, sizedNode) {
		return A2(
...
var author$project$Main$Foo = function (a) {
	return {$: 'Foo', a: a};
};
var author$project$Main$Tick = function (a) {
	return {$: 'Tick', a: a};
};
var author$project$Main$DagreResult = F2(
...
var author$project$Main$edgeDecoder = elm$json$Json$Decode$list(
	A2(
...
var author$project$Main$positionedNodeKvpDecoder = elm$json$Json$Decode$keyValuePairs(author$project$NodeDict$positionedNodeDecoder);
var author$project$Main$dagreResultDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Main$DagreResult,
	A2(elm$json$Json$Decode$field, 'edges', author$project$Main$edgeDecoder),
	A2(elm$json$Json$Decode$field, 'nodes', author$project$Main$positionedNodeKvpDecoder));
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$Main$renderNodes = _Platform_incomingPort('renderNodes', elm$json$Json$Decode$value);
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Main$wsEcho = _Platform_incomingPort('wsEcho', elm$json$Json$Decode$string);
...
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Main$wsEcho(author$project$Main$Echo),
				author$project$Main$renderNodes(
				A2(
					elm$core$Basics$composeR,
					elm$json$Json$Decode$decodeValue(author$project$Main$dagreResultDecoder),
...
var author$project$Main$parseEcho = F2(
	function (value, model) {
		var _n0 = A2(elm$core$String$split, ' ', value);
		_n0$2:
		while (true) {
			if (_n0.b && _n0.b.b) {
				if (!_n0.b.b.b) {
					if (_n0.a === 'device_connected') {
						var _n1 = _n0.b;
						var vdeviceId = _n1.a;
					...
					if (((_n0.a === 'device_data_recv') && _n0.b.b.b.b) && (!_n0.b.b.b.b.b)) {
						var _n2 = _n0.b;
						var vdeviceId = _n2.a;
						var _n3 = _n2.b;
						var ts = _n3.a;
						var _n4 = _n3.b;
						var v = _n4.a;
						var operatorDatum = _Utils_Tuple2(
							A2(
...
var author$project$NodeDict$encodeSizedNode = function (_n0) {
...
var author$project$NodeDict$union = function (nodeDict) {
	var sizedDict = nodeDict.a;
...
var author$project$NodeDict$encodeNodesToBePositioned = function (nodeDict) {
	var sizedNodeDict = nodeDict.a;
	var positionedNodeDict = nodeDict.b;
	var _n1 = elm$core$Dict$isEmpty(sizedNodeDict);
	if (_n1) {
		return elm$core$Maybe$Nothing;
	} else {
		return elm$core$Maybe$Just(
			A3(
				...
				author$project$NodeDict$encodeSizedNode,
				author$project$NodeDict$union(nodeDict)));
	}
};
var author$project$NodeDict$positionNode = F3(
	function (key, positionedNode, nodeDict) {
		var sizedNodeDict = nodeDict.a;
		var positionedNodeDict = nodeDict.b;
		return A2(
			author$project$NodeDict$NodeDict,
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Echo':
				var value = msg.a;
				var updatedModel = A2(author$project$Main$parseEcho, value, model);
				var mEncodedNodes = author$project$NodeDict$encodeNodesToBePositioned(updatedModel.nodeDict);
				if (mEncodedNodes.$ === 'Nothing') {
					return _Utils_Tuple2(updatedModel, elm$core$Platform$Cmd$none);
				} else {
					var encodedNodes = mEncodedNodes.a;
					return _Utils_Tuple2(
						updatedModel,
						author$project$Main$positionNodes(encodedNodes));
				}
			case 'Foo':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var nodes = result.a.nodes;
					var edges = result.a.edges;
							...
							nodeDict: A3(
								...
								F2(
									function (_n3, acc) {
										var k = _n3.a;
										var pn = _n3.b;
										return A3(author$project$NodeDict$positionNode, k, pn, acc);
									}),
								model.nodeDict,
								nodes)
						});
			...
			default:
				var tickPosix = msg.a;
				var tickMillis = elm$time$Time$posixToMillis(tickPosix);
				var time = tickMillis - 5000;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
...
var author$project$Main$positionedNodeToSvgAttrs = function (_n0) {
	var height = _n0.height;
	var width = _n0.width;
	var x = _n0.x;
	var y = _n0.y;
	return _List_fromArray(
		[
			...
			elm$core$String$fromFloat(y - (height / 2))),
...
var author$project$NodeDict$positionedNodes = function (nodeDict) {
	var positionedDict = nodeDict.b;
...
var author$project$Main$view = function (model) {
	...
	var toPointsString = function (points) {
		return A3(
			elm$core$List$foldl,
			F2(
				function (pointString, acc) {
					return acc + (' ' + pointString);
				}),
			'',
			A2(
				elm$core$List$map,
	...
	var dataToPointsString = function (data) {
